...
namespace NobleConnect.UNet
{
    ...
    public class NobleNetworkLobbyManager : NobleNetworkManager
    {
        ...
        [SerializeField] NobleLobbyPlayer m_LobbyPlayerPrefab;
        ...
        public NobleLobbyPlayer[] lobbySlots;
        ...
        public NobleLobbyPlayer lobbyPlayerPrefab { get { return m_LobbyPlayerPrefab; } set { m_LobbyPlayerPrefab = value; } }
        ...
        {
            var lobbyPlayer = lobbyPlayerGameObject.GetComponent<NobleLobbyPlayer>();
            if (lobbyPlayer == null)
            {
            ...
            if (LogFilter.logDebug) { Logger.Log("NetworkLobby SceneLoadedForPlayer scene:" + loadedSceneName + " " + conn); }
        ...
        static int CheckConnectionIsReadyToBegin(NetworkConnection conn)
        {
            ...
            for (int i = 0; i < conn.playerControllers.Count; i++)
            {
                ...
                if (player.IsValid)
                {
                    var lobbyPlayer = player.gameObject.GetComponent<NobleLobbyPlayer>();
        ...
        public void ServerReturnToLobby()
        {
            ...
            {
                Logger.Log("ServerReturnToLobby called on client");
                return;
            }
        ...
        public override void OnServerAddPlayer(NetworkConnection conn, short playerControllerId)
        {
            ...
            var newLobbyPlayer = newLobbyGameObject.GetComponent<NobleLobbyPlayer>();
        ...
        public override void OnServerRemovePlayer(NetworkConnection conn, PlayerController player)
        {
            ...
            byte slot = player.gameObject.GetComponent<NobleLobbyPlayer>().slot;
        ...
        {
            if (LogFilter.logDebug) { Logger.Log("NetworkLobbyManager OnServerReadyToBeginMessage"); }
            ...
            var lobbyPlayer = lobbyController.gameObject.GetComponent<NobleLobbyPlayer>();
        ...
        {
            if (LogFilter.logDebug) { Logger.Log("NetworkLobbyManager OnSceneLoadedMessage"); }
        ...
        {
            if (LogFilter.logDebug) { Logger.Log("NetworkLobbyManager OnServerReturnToLobbyMessage"); }
        ...
        public override void OnStartServer()
        {
            ...
            {
                lobbySlots = new NobleLobbyPlayer[maxPlayers];
            }
        ...
        {
            if (LogFilter.logDebug) { Logger.Log("NetworkLobbyManager Add Player failed."); }
        ...
        public void TryToAddPlayer()
        {
            if (NetworkClient.active)
            {
                ...
                if (LogFilter.logDebug) { Logger.Log("NetworkLobbyManager TryToAddPlayer controllerId " + controllerId + " ready:" + ClientScene.ready); }

                if (controllerId == -1)
                {
                    if (LogFilter.logDebug) { Logger.Log("NetworkLobbyManager No Space!"); }
                    return;
                }
            ...
            {
                if (LogFilter.logDebug) { Logger.Log("NetworkLobbyManager NetworkClient not active!"); }
            }
        }
    }
}