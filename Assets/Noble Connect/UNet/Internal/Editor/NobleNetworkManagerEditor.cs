...
{
    [CustomEditor(typeof(NobleNetworkManager), true)]
    [CanEditMultipleObjects]
    public class NobleNetworkManagerEditor : Editor
    {
        ...
        protected SerializedProperty m_ForceRelayProperty;
        protected SerializedProperty m_RegionProperty;
        ...
        protected GUIContent m_ForceRelayLabel;
        protected GUIContent m_RegionLabel;
        ...
        protected NobleNetworkManager m_NetworkManager;
        ...
        protected void Init()
        {
            ...
            m_Initialized = true;
            m_NetworkManager = target as NobleNetworkManager;
            ...
            m_ForceRelayLabel = new GUIContent("Force Relay Connection", "You can enable this to force relay connections to be used for testing purposes");
            m_RegionLabel = new GUIContent("Region", "The geographic region to use when selecting a relay server");
            ...
            m_ForceRelayProperty = serializedObject.FindProperty("forceRelayConnection");
            m_RegionProperty = serializedObject.FindProperty("region");
        ...
        protected void ShowSpawnInfo()
        {
            ...
            //The NobleNetworkLobbyManager doesnt use playerPrefab, it has its own player prefab slots, so dont show this
            if (!m_NetworkManager.GetType().IsSubclassOf(typeof(NobleNetworkLobbyManager)))
            {
        ...
        protected void ShowNetworkInfo()
        {
            ...
            //This property has no effect on code related to SourceID.
