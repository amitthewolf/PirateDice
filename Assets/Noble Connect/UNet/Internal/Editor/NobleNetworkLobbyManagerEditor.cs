...
{
    [CustomEditor(typeof(NobleNetworkLobbyManager), true)]
    [CanEditMultipleObjects]
    class NobleNetworkLobbyManagerEditor : NobleNetworkManagerEditor
    {
        ...
        void InitLobby()
        {
            if (!m_Initialized)
            {
                ...
                var lobby = target as NobleNetworkLobbyManager;
                if (lobby == null)
                    return;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_ForceRelayProperty, m_ForceRelayLabel);
            EditorGUILayout.PropertyField(m_RegionProperty, m_RegionLabel);
            ...
            ShowDerivedProperties(typeof(NobleNetworkLobbyManager), typeof(NetworkManager));
        ...
        void SetLobbyScene(NobleNetworkLobbyManager lobby, string sceneName)
        {
        ...
        void SetPlayScene(NobleNetworkLobbyManager lobby, string sceneName)
        {
